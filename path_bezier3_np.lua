--Solving the Nearest Point-on-Curve Problem from Graphics Gems

local MAXDEPTH = 64

local EPSILON (1*2^(-MAXDEPTH-1) --Flatness control value */
#define	DEGREE	3			--  Cubic Bezier curve		*/
#define	W_DEGREE 5			--  Degree of eqn to find roots of */

local NearestPointOnCurve(Px, Vx)
	local Px, V0x, V0y, V1x, V1y
