...
Create a new scene graph renderer that can draw scene graph objects on a cairo surface. A [sg_cache cache] object can be passed so you can share cached resources like fonts and images with other renderers, otherwise a private cache object will be created.
