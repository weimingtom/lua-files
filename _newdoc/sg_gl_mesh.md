OpenGL scene graph mesh objects

v1.0 | [code](http://code.google.com/p/lua-files/source/browse/sg_gl_mesh.lua)

## `require'sg_gl_mesh'`

Extends [sg_gl sg_gl] to render mesh type objects.
...
Textures can be either [imagefile image files] or cairo [sg_cairo scene graphs].
