...
line_styles = {type = 'group',
	{type = 'group', x = 240, y = 40,
		{type = 'shape', line_join = 'miter', x = 0, line_cap = 'butt',
			path = {'move', 0, 0, 'line', 40, 50, 70, 0}, stroke = {type = 'color', 1,1,1,.5}, line_width = 20},
		...
		{type = 'shape', x = 0,
			path = {'move', 0, 0, 'line', 40, 50, 70, 0}, stroke = {type = 'color', 1,1,1,1}, line_width = 1},
		{type = 'shape', x = 120,
			path = {'move', 0, 0, 'line', 40, 50, 70, 0}, stroke = {type = 'color', 1,1,1,1}, line_width = 1},
		{type = 'shape', x = 240,
			path = {'move', 0, 0, 'line', 40, 50, 70, 0}, stroke = {type = 'color', 1,1,1,1}, line_width = 1},
...
local fill_rule = {type = 'group',
	{type = 'group', x = 960, y = 10,
		{type = 'shape', x = 0, fill_rule = 'evenodd',
			path = {'move', 0, 0, 'circle', 50, 50, 50, 50, 50, 20},
...
local scene = {type = 'group', {type = 'page', contents = scene}}

local glue = require'glue'
local convert = require'sg_pdf'
