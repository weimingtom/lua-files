require'unit'
update(_G, require'uri')

test(escape('some&some=other', '&='), 'some%26some%3dother')
test(format{scheme = 'http', host = 'dude.com', path = '/', fragment = 'top'}, 'http://dude.com/#top')
test(format{scheme = 'http', host = 'dude.com', path = '//../.'}, 'http://dude.com//../.')
test(format{scheme = 'http', host = 'dude.com', query = 'a=1&b=2 3'}, 'http://dude.com?a=1&b=2+3')
test(format{scheme = 'http', host = 'dude.com', args = {a='1',b='2 3'}}, 'http://dude.com?a=1&b=2+3')
test(format{scheme = 'http', host = 'dude.com', path = '/redirect',
...
test(parse'?a=1&b=2&c=&d&f=hidden&f=visible&g=a=1%26b=2', {query='a=1&b=2&c=&d&f=hidden&f=visible&g=a=1&b=2',
				args={a='1',b='2',c='',d='',f='visible',g='a=1&b=2'}})
test(parse'http://user:pass@host/a/b?x=1&y=2&z&w=#fragment',
