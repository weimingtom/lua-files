--hb.h from harfbuzz HEAD from May 24, 2013
...
typedef enum
{
  ...
  HB_SCRIPT_CANADIAN_ABORIGINAL = ((hb_tag_t)((((uint8_t)('C'))<<24)|(((uint8_t)('a'))<<16)|(((uint8_t)('n'))<<8)|((uint8_t)('s')))),
...
hb_script_t    hb_script_from_string       (const char *s, int len);
