...
function recursive_bezier(x1, y1, x2, y2, x3, y3, level, t1, t2, m_distance_tolerance2, m_angle_tolerance)
	...
	recursive_bezier(x1, y1, x12, y12, x123, y123, level + 1, t1, t12, m_distance_tolerance2, m_angle_tolerance)
	recursive_bezier(x123, y123, x23, y23, x3, y3, level + 1, t12, t2, m_distance_tolerance2, m_angle_tolerance)
	return t1, t2
end
